            ...
            <div class="time-tools-grid">
                <div class="tool-card">
                    ...
                    <form method="POST" class="time-form">
                        ...
                        <input type="datetime-local" name="exit_time" placeholder="เวลาออก (ถ้าต้องการ)">
                        <button type="submit" class="btn btn-primary">แก้ไขเวลา</button>
                    </form>
                </div>
                
                <div class="tool-card">
                    <h4>⏱️ เพิ่มเวลาจอด</h4>
                    <form method="POST" class="time-form">
                        ...
                        <button type="submit" class="btn btn-success">เพิ่มเวลา</button>
                    </form>
                </div>
                ...
                <div class="tool-card">
                    <h4>🚗 จำลองการออก</h4>
                    <form method="POST" class="time-form">
                        <input type="hidden" name="simulate_exit" value="1">
                        <input type="text" name="card_id" placeholder="Card ID" required>
                        <button type="submit" class="btn btn-info">จำลองออก</button>
                    </form>
                </div>
                ...
                <div class="tool-card">
                    ...
                    <form method="POST" class="time-form">
                        <input type="hidden" name="create_scenario" value="1">
                        <select name="scenario_type" required>
                            <option value="">เลือกสถานการณ์</option>
                            <option value="short_term">จอดสั้น (2 ชั่วโมง)</option>
                            <option value="overnight">ค้างคืน (8 ชั่วโมง)</option>
                            <option value="full_day">จอดทั้งวัน (24 ชั่วโมง)</option>
                            <option value="completed">ออกแล้ว (5 ชั่วโมง)</option>
                        </select>
                        <button type="submit" class="btn btn-warning">สร้างสถานการณ์</button>
                    </form>
                </div>
            </div>
        </div>
